...
<section class="p-2 flex flex-1 overflow-hidden">
    <DragDropSlides bind:selectedSlide={selectedSlide} bind:renderMarkdown={renderMarkdown} />
    {#if $showSlides.length < 1}
        <div class="w-full grid place-items-center border-dashed border-2 border-white">
